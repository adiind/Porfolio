...
import { Briefcase, GraduationCap, User, Sparkles, Heart, MessageCircle, ArrowUpRight, Trophy, ScrollText, PlayCircle, Flower, Eye } from 'lucide-react';
    ...
    if (isVignette) {
      return (
        <motion.div
          ...
          animate={{ top, opacity: 1, x: 0, zIndex: isHovered ? 60 : 30 }}
          style={{
            position: 'absolute',
