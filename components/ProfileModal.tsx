    ...
    >
      ...
      >
        ...
        <div className="flex-1 p-6 md:p-10 flex flex-col overflow-y-auto custom-scrollbar">
          <div className="mb-6">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-2">Hello, I'm Adi.</h2>
            <p className="text-rose-400 font-medium tracking-wide uppercase text-sm">Design Engineer & Product Thinker</p>
          </div>

          <div className="space-y-6 text-gray-300 text-sm md:text-base leading-relaxed mb-8 font-light">
            {PROFILE_BIO.split('\n\n').map((paragraph, index) => (
